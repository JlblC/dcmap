inherited MainPrefsFrame: TMainPrefsFrame
  Width = 376
  Height = 316
  ExplicitWidth = 376
  ExplicitHeight = 316
  ...
  object XPStylesCheck: TsCheckBox [7]
    Left = 9
    Top = 260
    Width = 345
    Height = 20
    Caption = 'XPStylesCheck'
    AutoSize = False
    TabOrder = 5
    OnClick = OnChange
    SkinData.SkinSection = 'CHECKBOX'
  ...
  object AnimationCheck: TsCheckBox [8]
    Left = 207
    Top = 289
    Width = 96
    Height = 20
  ...
  object PreviewCheck: TsCheckBox [9]
    Left = 9
    Top = -3
    Width = 87
    Height = 20
  ...
  object DownloadSkinsBtn: TsBitBtn [10]
    Left = 184
    Top = 3
    Width = 170
    Height = 42
